...
@Autonomous
public class HeliosAutoBlue extends LinearOpMode {
...
//lift skystone grabber back into robot ^
        ...
        currentX = robot.globalPositionUpdate.returnXCoordinate() / robot.COUNTS_PER_INCH;
        robot.goToPosition(currentX,-40,0.6,0,4,5,robot.BACKWARD);
...
//move the servo to grab the foundation
        ...
        robot.goToPosition(90,-17,1,0,6,1.5,robot.BACKWARD);
