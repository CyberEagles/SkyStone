...
public class StrafeExperiment extends LinearOpMode {
...
//                robot.rightBackDrive.setTargetPosition(newRightBackTarget);
            ...
            // keep looping while we are still active, and BOTH motors are running.
            while (opModeIsActive() && (-robot.leftFrontDrive.getCurrentPosition()>-newLeftFrontTarget)){
                ...
                error = 0; //getError(angle);
                steer = getSteer(error, P_DRIVE_COEFF);
                telemetry.addData("Current Position", robot.leftFrontDrive.getCurrentPosition());    //
                telemetry.addData("Target Position",newLeftFrontTarget);    //
                telemetry.addData("Error", error);
                telemetry.addData("Speed", speed);
                telemetry.update();
